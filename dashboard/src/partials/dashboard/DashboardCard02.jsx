...
function DashboardCard02() {
  ...
  return (
    <div className="flex flex-col col-span-1 sm:col-span-6 xl:col-span-1 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">Potential Revenue Missed</h2>
        ...
        <div className="flex items-start">
          ...
          <div className="text-sm font-semibold text-white px-1.5 bg-amber-500 rounded-full">USD</div>
        </div>
      </div>
